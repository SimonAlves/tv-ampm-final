...
// --- CONFIGURAÇÃO PARA USAR SUAS IMAGENS ---
let campanhas = [
    // SLIDE 0: COMBUSTÍVEL (Sua imagem slide1.jpg)
    { 
        id: 0, 
        tipo: 'foto', 
        arquivo: "slide1.jpg", 
        nome: "Sorteio 50% OFF", // Nome pro celular
        qtd: 5, 
        totalResgates: 0,
        ativa: true, 
        corPrincipal: '#FFD700', 
    ...
    // SLIDE 1: DUCHA GRÁTIS (Sua imagem slide2.jpg)
    { 
        id: 1, 
        tipo: 'foto', 
        arquivo: "slide2.jpg", 
    ...
    // SLIDE 2: CAFÉ (Sua imagem slide3.jpg)
    { 
        id: 2, 
        tipo: 'foto', 
        arquivo: "slide3.jpg", 
...
// --- HTML DA TV (LIMPO PARA VALORIZAR SUA IMAGEM) ---
const htmlTV = `
<!DOCTYPE html>
<html>
...
<body style="margin:0; background:black; overflow:hidden; font-family:Arial; display:flex; flex-direction:column; height:100vh;">
    <div style="display:flex; flex:1; width:100%;">
        <div style="flex:3; background:#000; display:flex; align-items:center; justify-content:center; overflow:hidden;">
        ...
        <div style="flex:1; background:#003399; display:flex; flex-direction:column; align-items:center; justify-content:center; border-left:6px solid #FFCC00; text-align:center; color:white;" id="bgDir">
            ...
            <p style="margin-top:15px; font-weight:bold; font-size:1.3rem; color:#FFCC00;">APONTE A CÂMERA</p>
    ...
    <script>
        ...
        function actualizarTela(d) {
            ...
            imgTag.src = d.arquivo; // Aqui ele puxa slide1.jpg, etc.
